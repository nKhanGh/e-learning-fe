  ...
  const features = [
      {
        ...
        description:
          "Access courses anytime, anywhere. Study on your schedule with lifetime access to course materials.",
      ...
      },
      {
        ...
        title: "Get Certified",
        description:
          "Earn recognized certificates upon completion to showcase your skills and boost your career.",
              ...
              <div className="relative bg-white dark:bg-surface rounded-3xl shadow-2xl p-8 h-full flex items-center justify-center border border-gray-200 dark:border-border">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-muted">
                    Start learning amazing things today
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-muted max-w-2xl mx-auto">
              Everything you need to advance your skills and achieve your goals
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
            <div>
              ...
              <p className="text-gray-600 dark:text-muted">
                Choose from 1000+ courses with new additions published every
                month
              </p>
            </div>
            <Link
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            ...
            access to 1000+ courses and start building your future.
          </p>
